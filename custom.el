   ...
   (quote
    ((eval let
     ...
     (eval let
           ...
           (setq-local company-clang-arguments
                       (list
                        (concat "-I" root "headers")
                        (concat "-I" root "source/mon")))
           (setq-local flycheck-clang-args
                       (quote
                        ("-ISystem /SCRATCH/anku/othello/linux64-packages/include" "-stdlib=libc++")))
           (setq-local flycheck-clang-language-standard "gnu++11")
           (setq-local flycheck-clang-include-path
                       (list root
                             (concat root "analysis")
     ...
     (eval setq flycheck-clang-include-path
           (list
            ...
            (expand-file-name "linux64-packages/include")
            (expand-file-name "linux64-packages/include/c++/4.9.2")
            (expand-file-name "linux64-packages/include/c++/4.9.2/x86_64-unknown-linux-gnu")))
     (eval setq flycheck-clang-include-path
           (list
            (expand-file-name "~/")
            (expand-file-name "~/analysis")
